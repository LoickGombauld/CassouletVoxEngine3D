...
namespace Voxel {
	...
	void WorldGenerator::testNoiseCPUvsGPU()
	{
		...
		for (int z = 0; z < gridSize; ++z)
		{
			for (int x = 0; x < gridSize; ++x)
			{
				 ...
				 * fractalNoise2D().
				 *
				 * Les paramÞtres doivent Ûtre les mÛmes
	...
	)
	{
		...
		/*
		 * Marge nÚcessaire pour les structures.
		 *
		 * Notre arbre peut s'Útendre de 2 blocs autour
		 * de son origine.
		 */
	...
	) const
	{
		 ...
		 * ------------------------------------------------------------
		 *
		 * TrÞs basse frÚquence.
		 *
		 * Sert principalement Ó dÚterminer o¨ se trouvent les
		 * rÚgions montagneuses.
		 */
		 ...
		 * ------------------------------------------------------------
		 *
		 * Donne les collines et variations gÚnÚrales.
		 */
		const float hills =
			m_noise->fractalNoise2D(
		 ...
		 * ------------------------------------------------------------
		 *
		 * FrÚquence plus ÚlevÚe.
		 *
		 * On garde une influence faible afin d'Úviter un terrain
		 * trop bruitÚ.
		 */
		const float detail =
			m_noise->fractalNoise2D(
		 ...
		 * ------------------------------------------------------------
		 *
		 * Les montagnes n'apparaissent que dans certaines rÚgions.
		 *
		 * smoothstep permet d'Úviter une transition brutale entre
		 * plaine et montagne.
		 */
		...
		/*
		 * Variation gÚnÚrale des collines.
		 */
		 ...
		 * ------------------------------------------------------------
		 *
		 * On amplifie fortement le relief dans les rÚgions
		 * sÚlectionnÚes par mountainMask.
		 */
	...
	) const
	{
	  ...
	  /*
		 ...
		 *
		 * Les dÚpressions situÚes sous le niveau marin
		 * sont remplies d'eau jusqu'Ó SEA_LEVEL.
		 */
